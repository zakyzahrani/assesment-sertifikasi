...
<body>
    ...
    {{-- <div class="rent-carousel">
        <a href="{{ route('about') }}">
            <div class="slider">
                <img src="{{ asset('user/img/2.png') }}" alt="banner">
            </div>
        </a>
        <a href="{{ route('index_boat') }}">
            <div class="slider">
                <img src="{{ asset('user/img/1.png') }}" alt="banner">
            </div>
        </a>
        <div class="btn-prev">
    ...
    <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <img src="{{ asset('user/img/2.png') }}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="{{ asset('user/img/1.png') }}" class="d-block w-100" alt="...">
            </div>
        </div>
